...
module Scoreboard(
    input clk,
    input [1:0] ball,
    input [3:0] p1_score0, p1_score1,
    input [3:0] p2_score0, p2_score1,
    input [9:0] x, y,
    output [3:0] text_on,
   ...
   always @*
    case(x[7:4])
        ...
        4'h2 : char_addr_s = 7'h5F;     // _
        4'h3 : char_addr_s = 7'h53;     // S
        4'h4 : char_addr_s = 7'h43;     // C
        4'h5 : char_addr_s = 7'h4F;     // O
        4'h6 : char_addr_s = 7'h52;     // R
        4'h7 : char_addr_s = 7'h45;     // E
        4'h8 : char_addr_s = 7'h50;     // P
        4'h9 : char_addr_s = 7'h32;     // 2
        4'hA : char_addr_s = 7'h5F;     // _
        4'hB : char_addr_s = 7'h53;     // S
        4'hC : char_addr_s = 7'h43;     // C
        4'hD : char_addr_s = 7'h4F;     // O
        4'hE : char_addr_s = 7'h52;     // R
        4'hF : char_addr_s = 7'h45;     // E
    endcase
